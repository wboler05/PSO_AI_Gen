...
# Concrete Example of a Maximization Fitness Function
class SphereMaximization(AbstractFitnessFunction):
    def evaluate(self, position: np.ndarray) -> float:
        return -np.sum(position**2)

def main():
    """
    Main function to run the PSO simulation for Sphere Maximization.
    """
    pso_parameters = {
        'dimensions': 2,
        'num_particles': 100,
    ...
    fitness_func = SphereMaximization()
